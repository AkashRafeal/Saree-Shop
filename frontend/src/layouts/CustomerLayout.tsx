          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-5">
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-[11px] text-stone-500">
                <li><Link to="/shop?sort=newest" className="hover:text-[#0A4D40] transition">New Arrivals</Link></li>
                <li><Link to="/shop?category=kanchipuram-silk" className="hover:text-[#0A4D40] transition">Pure Silk Sarees</Link></li>
                <li><Link to="/shop?category=banarasi-silk" className="hover:text-[#0A4D40] transition">Designer Banarasi</Link></li>
                <li><Link to="/shop?category=bridal-sarees" className="hover:text-[#0A4D40] transition">Bridal Trousseau</Link></li>
                <li><Link to="/shop?occasion=Festive" className="hover:text-[#0A4D40] transition">Festive Collection</Link></li>
                <li><Link to="/shop" className="hover:text-[#0A4D40] transition">Exclusive Sale</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-[11px] text-stone-500">
                <li><Link to="/my-orders" className="hover:text-[#0A4D40] transition">Track Order</Link></li>
                <li><Link to="/my-orders" className="hover:text-[#0A4D40] transition">Return & Exchange</Link></li>
                <li><Link to="/shop" className="hover:text-[#0A4D40] transition">Shipping Policy</Link></li>
                <li><Link to="/shop" className="hover:text-[#0A4D40] transition">Terms & Conditions</Link></li>
                <li><Link to="/shop" className="hover:text-[#0A4D40] transition">Privacy Policy</Link></li>
