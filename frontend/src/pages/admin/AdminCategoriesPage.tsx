      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="inline-flex items-center gap-1 text-[11px] font-bold uppercase tracking-wider text-[#0A5C44] bg-emerald-50 border border-emerald-200/80 px-2.5 py-0.5 rounded-full">
        ...
        <button
          ...
          className="inline-flex items-center space-x-2 bg-[#0A5C44] hover:bg-[#064E3B] text-white px-6 py-2.5 rounded-full font-bold text-xs uppercase tracking-wider shadow-md shadow-[#0A5C44]/20 transition cursor-pointer self-start sm:self-auto"
        >
      ...
      <div className="bg-white p-4 rounded-2xl border border-stone-200 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 border border-stone-200 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-[#0A5C44]/20 focus:border-[#0A5C44] transition"
          />
        </div>
      ...
      <div className="bg-white rounded-2xl border border-stone-200 shadow-xs overflow-hidden">
        {loading ? (
          <div className="p-12 text-center text-xs text-stone-400">
            <div className="w-6 h-6 border-2 border-[#0A5C44] border-t-transparent rounded-full animate-spin mx-auto mb-2" />
            Loading saree categories...
          </div>
        ) : filteredCategories.length === 0 ? (
          <div className="p-12 text-center space-y-3">
            <div className="w-12 h-12 bg-emerald-50 text-[#0A5C44] rounded-2xl flex items-center justify-center mx-auto">
            ...
            {!search && (
              <button
                onClick={handleOpenAddModal}
                className="mt-2 text-xs font-bold text-[#0A5C44] hover:underline"
              >
                    ...
                    <tr key={cat.id} className="hover:bg-[#FAF8F5]/80 transition-colors">
                      ...
                      <td className="py-3.5 px-4">
                        <span className="inline-flex items-center gap-1 text-[11px] font-bold text-stone-800 bg-stone-100 px-2.5 py-1 rounded-full border border-stone-200/60 tabular-nums">
                          <Package className="w-3 h-3 text-[#0A5C44]" />
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <div className="flex items-center justify-end space-x-1.5">
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="p-1.5 text-stone-400 hover:text-[#0A5C44] hover:bg-emerald-50 rounded-lg transition"
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-stone-900/60 backdrop-blur-xs">
            <div className="bg-white rounded-3xl max-w-lg w-full overflow-hidden shadow-2xl border border-stone-200 animate-scaleUp">
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-stone-100 bg-[#FAF8F5]">
                <div className="flex items-center gap-2">
                  <div className="w-7 h-7 rounded-lg bg-[#0A5C44]/10 text-[#0A5C44] flex items-center justify-center">
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-stone-300 rounded-r-xl text-xs font-mono focus:outline-none focus:ring-2 focus:ring-[#0A5C44]/20 focus:border-[#0A5C44]"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center bg-stone-100 p-0.5 rounded-lg text-[10px] font-semibold">
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-md transition cursor-pointer flex items-center gap-1 ${
                          imageInputMode === 'url'
                            ? 'bg-white text-[#0A5C44] shadow-xs'
                  ...
                  {imageInputMode === 'url' ? (
                    ...
                    <div>
                      <label className="border-2 border-dashed border-stone-300 hover:border-[#0A5C44] bg-stone-50 rounded-xl p-4 flex flex-col items-center justify-center cursor-pointer transition">
                        <input
                          ref={fileInputRef}
                          type="file"
                          accept="image/*"
                          ...
                          className="hidden"
                        />
                        <ImagePlus className="w-5 h-5 text-[#0A5C44] mb-1" />
                ...
                <div className="pt-2">
                  <label className="inline-flex items-center space-x-2 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 text-[#0A5C44] border-stone-300 rounded focus:ring-[#0A5C44]"
                    />
                ...
                <div className="pt-4 border-t border-stone-100 flex items-center justify-end space-x-3">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="px-6 py-2 bg-[#0A5C44] hover:bg-[#064E3B] text-white rounded-full text-xs font-bold transition shadow-md shadow-[#0A5C44]/20 disabled:opacity-50 cursor-pointer flex items-center gap-1.5"
                  >
                    {submitting ? (
                      <>
