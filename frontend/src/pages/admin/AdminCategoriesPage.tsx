      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="inline-flex items-center gap-1 text-[11px] font-bold uppercase tracking-wider text-[#D81B60] bg-rose-50 border border-rose-200/80 px-2.5 py-0.5 rounded-full">
      ...
      <div className="bg-white p-4 rounded-2xl border border-stone-200 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 border border-stone-200 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-[#D81B60]/20 focus:border-[#D81B60] transition"
          />
        </div>
      ...
      <div className="bg-white rounded-2xl border border-stone-200 shadow-xs overflow-hidden">
        {loading ? (
          <div className="p-12 text-center text-xs text-stone-400">
            <div className="w-6 h-6 border-2 border-[#D81B60] border-t-transparent rounded-full animate-spin mx-auto mb-2" />
            Loading saree categories...
          </div>
        ) : filteredCategories.length === 0 ? (
          <div className="p-12 text-center space-y-3">
            <div className="w-12 h-12 bg-rose-50 text-[#D81B60] rounded-2xl flex items-center justify-center mx-auto">
            ...
            {!search && (
              <button
                onClick={handleOpenAddModal}
                className="mt-2 text-xs font-bold text-[#D81B60] hover:underline"
              >
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <div className="flex items-center justify-end space-x-1.5">
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="p-1.5 text-stone-400 hover:text-[#D81B60] hover:bg-rose-50 rounded-lg transition"
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-stone-900/60 backdrop-blur-xs">
            <div className="bg-white rounded-3xl max-w-lg w-full overflow-hidden shadow-2xl border border-stone-200 animate-scaleUp">
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-stone-100 bg-[#FAF8F5]">
                <div className="flex items-center gap-2">
                  <div className="w-7 h-7 rounded-lg bg-[#D81B60]/10 text-[#D81B60] flex items-center justify-center">
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-stone-300 rounded-r-xl text-xs font-mono focus:outline-none focus:ring-2 focus:ring-[#D81B60]/20 focus:border-[#D81B60]"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {imageInputMode === 'url' ? (
                    ...
                    <div>
                      <label className="border-2 border-dashed border-stone-300 hover:border-[#D81B60] bg-stone-50 rounded-xl p-4 flex flex-col items-center justify-center cursor-pointer transition">
                        <input
                          ref={fileInputRef}
                          type="file"
                          accept="image/*"
                          ...
                          className="hidden"
                        />
                        <ImagePlus className="w-5 h-5 text-[#D81B60] mb-1" />
                ...
                <div className="pt-2">
                  <label className="inline-flex items-center space-x-2 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 text-[#D81B60] border-stone-300 rounded focus:ring-[#D81B60]"
                    />
