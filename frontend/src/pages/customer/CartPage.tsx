      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <Link
                      ...
                      className="font-serif text-sm font-semibold text-stone-900 hover:text-brand-maroon transition line-clamp-1"
                    >
                      {item.productName}
                    </Link>
          ...
          <div className="flex justify-between items-center text-xs">
            <Link to="/shop" className="text-brand-maroon font-semibold hover:underline">
            ...
            <form onSubmit={handleApplyCoupon} className="space-y-2">
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  className="w-full text-xs pl-4 pr-20 py-2.5 rounded-full border border-stone-300 focus:outline-none focus:border-[#0A4D40] uppercase font-semibold transition shadow-inner"
                />
                <button
                  type="submit"
                  className="absolute right-1 bg-[#0A4D40] hover:bg-[#062E28] text-white font-bold text-xs px-4 py-1.5 rounded-full transition shadow-sm cursor-pointer"
                >
                  Apply
                </button>
              </div>
