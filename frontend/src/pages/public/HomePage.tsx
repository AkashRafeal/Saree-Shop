    ...
    <div className="space-y-16 pb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 min-h-[500px] sm:min-h-[540px] items-center py-6 md:py-8">
            ...
            <div key={`text-${heroSlide}`} className="md:col-span-6 py-6 md:py-12 pr-0 md:pr-8 z-10 flex flex-col justify-center animate-fadeIn">
              ...
              <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-normal text-stone-900 leading-tight">
                ...
                <span className="block font-serif font-bold text-[#D81B60]">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h2 className="font-serif text-2xl sm:text-3xl text-stone-900 mt-1">
          Shop By <span className="text-[#D81B60] font-bold">Category</span>
        </h2>
        ...
        <div className="mt-8 flex items-center justify-center space-x-6 sm:space-x-10 overflow-x-auto py-2 px-4 no-scrollbar">
          {circularCategories.map((cat) => (
            ...
            >
              <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden p-0.5 border-2 border-transparent group-hover:border-[#D81B60] transition-all duration-300 shadow-sm">
                <img
                  src={cat.image}
                  alt={cat.name}
              ...
              <span className="mt-3 text-[10px] sm:text-xs font-bold tracking-wider text-stone-800 uppercase group-hover:text-[#D81B60] transition-colors">
                {cat.name}
              </span>
            </Link>
          ))}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-6 pb-2 border-b border-stone-200">
          <h2 className="font-serif text-xl sm:text-2xl text-stone-900">
            Shop By <span className="text-[#D81B60] font-bold">Occasion</span>
          </h2>
          <Link
            to="/shop"
            className="text-[11px] font-bold text-stone-600 hover:text-[#D81B60] uppercase tracking-wider inline-flex items-center transition"
          >
            <span>VIEW ALL OCCASIONS</span>
            <ChevronRight className="w-3.5 h-3.5 ml-0.5 text-[#D81B60]" />
          </Link>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-6 pb-2 border-b border-stone-200">
          <h2 className="font-serif text-xl sm:text-2xl text-stone-900">
            New <span className="text-[#D81B60] font-bold">Arrivals</span>
          </h2>
          <Link
            to="/shop?sort=newest"
            className="text-[11px] font-bold text-stone-600 hover:text-[#D81B60] uppercase tracking-wider inline-flex items-center transition"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-6 pb-2 border-b border-stone-200">
          <h2 className="font-serif text-xl sm:text-2xl text-stone-900">
            Our Featured <span className="text-[#D81B60] font-bold">Collection</span>
          </h2>
          <Link
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-6 pb-2 border-b border-stone-200">
          <h2 className="font-serif text-xl sm:text-2xl text-stone-900">
            Reviews & <span className="text-[#D81B60] font-bold">Ratings</span>
          </h2>
          <Link
            to="/reviews"
            className="text-[11px] font-bold text-stone-600 hover:text-[#D81B60] uppercase tracking-wider inline-flex items-center transition"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {reviews.map((rev) => (
            <Link
              key={rev.id}
              to="/reviews"
              className="bg-white p-6 rounded-xl border border-stone-200 shadow-sm flex flex-col justify-between space-y-4 hover:shadow-md hover:border-[#D81B60]/30 transition group"
            >
              <div>
              ...
              <div className="flex items-center space-x-3 pt-3 border-t border-stone-100">
                <div className="w-8 h-8 rounded-full bg-rose-50 text-[#D81B60] font-serif font-bold text-xs flex items-center justify-center group-hover:bg-[#D81B60] group-hover:text-white transition">
                  {rev.author.charAt(0)}
                </div>
                <div>
                  <h4 className="text-xs font-bold text-stone-900 group-hover:text-[#D81B60] transition">{rev.author}</h4>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 text-center">
            ...
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 rounded-full bg-white border border-stone-200 flex items-center justify-center text-[#D81B60] mb-3 shadow-sm">
